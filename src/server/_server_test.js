...
(function() {
  ...
  var TEST_HOME_PAGE = testDir + "/testHome.html";
  var TEST_404_PAGE = testDir + "/test404.html";
  var PORT = 5020;
  var BASE_SERVER_URL = "http://localhost:" + PORT;
  ...
  exports.test_servesHomePageFromFile = function(test){
    ...
    httpGet(BASE_SERVER_URL, function(response, responseData){
  ...
  exports.test_returns404ForEverythingExceptHomePage = function(test){
    ...
    httpGet(BASE_SERVER_URL + "/bargle", function(response, responseData){
  ...
  exports.test_returnsHomePageWhenAskedForIndex = function(test) {
    ...
    httpGet(BASE_SERVER_URL + "/index.html", function(response, responseData) {
      test.equals(200, response.statusCode, "status code");
      test.done();
    });
  };
